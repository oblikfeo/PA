...
@section('content')
    ...
    {{-- Форма поиска (GET): поля в строке поиска привязываются сюда через form="search-form" --}}
    <form id="search-form" method="GET" action="{{ url()->current() }}" autocomplete="off" class="d-none" aria-hidden="true"></form>
